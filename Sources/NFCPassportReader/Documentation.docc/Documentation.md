...
The current architecture keeps the existing PACE and Chip Authentication behavior as the source of truth while extracting smaller Swift-native primitives around APDU commands, APDU status handling, and generic data-group parsing.
